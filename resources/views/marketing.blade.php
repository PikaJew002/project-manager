...
<body class="font-sans text-textDark bg-white antialiased overflow-x-hidden">
    ...
    <section class="relative pt-40 pb-20 lg:pt-48 lg:pb-32 overflow-hidden flex flex-col items-center text-center px-6">
        ...
        <div class="relative w-full max-w-6xl mx-auto z-20 animate-float">
            <img
                src="{{ asset('storage/screenshot-2026-06-14-2-02.png') }}"
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16 py-16">
                ...
                <div class="lg:w-1/2 w-full relative">
                    <img src="{{ asset('storage/screenshot-2026-06-14-2-02.png') }}" alt="Cross-project dashboard" class="w-full rounded-2xl shadow-xl border border-gray-200">
                </div>
            </div>
            ...
            <div id="views" class="flex flex-col lg:flex-row-reverse items-center gap-16 py-24">
                ...
                <div class="lg:w-1/2 w-full relative h-[300px] sm:h-[400px] lg:h-[500px]">
                    <img src="{{ asset('storage/screenshot-2026-06-14-2-02.png') }}" alt="Kanban Board View" class="absolute top-0 left-0 w-4/5 rounded-2xl shadow-2xl border border-gray-200 z-10 hover:z-30 transition-z duration-300">
                    <img src="{{ asset('storage/screenshot-2026-06-14-2-01.png') }}" alt="Grid View" class="absolute bottom-0 right-0 w-4/5 rounded-2xl shadow-2xl border border-gray-200 z-20 hover:z-30 transition-z duration-300 translate-y-8 sm:translate-y-0">
                </div>
            </div>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16 py-24">
                ...
                <div class="lg:w-1/2 w-full">
                    <img src="{{ asset('storage/screenshot-2026-06-14-2-00.png') }}" alt="Private Projects Interface" class="w-full rounded-2xl shadow-xl border border-gray-200">
                </div>
            </div>
            ...
            <div id="collaboration" class="flex flex-col lg:flex-row-reverse items-center gap-16 py-16">
                ...
                <div class="lg:w-1/2 w-full">
                    <img src="{{ asset('storage/screenshot-2026-06-14-2-03.png') }}" alt="Organization and Invites" class="w-full rounded-2xl shadow-xl border border-gray-200">
                </div>
            </div>
