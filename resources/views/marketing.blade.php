...
@section('content')
    ...
    <section class="relative pt-40 pb-20 lg:pt-48 lg:pb-32 overflow-hidden flex flex-col items-center text-center px-6">
        ...
        <div
            class="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[600px] fluid-bg-soft opacity-30 blur-[100px] rounded-full z-0 pointer-events-none animate-gradient-x">
        </div>
        ...
        <div class="relative w-full max-w-6xl mx-auto z-20 animate-float">
            <img src="{{ asset('images/screenshot-2026-06-14-2-02-jpeg.jpg') }}"
    ...
    <section id="features" class="py-24 bg-appLightBg/50 relative">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16 py-16">
                <div class="lg:w-1/2">
                    <div
                        class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-teal-100 text-teal-600 mb-6">
                    ...
                    <p class="text-lg text-textMuted leading-relaxed">
                        Stop context-switching. See everything on your plate in one unified view. The 'Your Tasks' dashboard
                        automatically aggregates tasks from every corner of your workspace. Whether it's a team project or a
                        personal checklist, see your entire world at a single glance.
                    </p>
                </div>
                <div class="lg:w-1/2 w-full relative">
                    <img src="{{ asset('images/screenshot-2026-06-14-2-02-jpeg.jpg') }}" alt="Cross-project dashboard"
            ...
            <div id="views" class="flex flex-col lg:flex-row-reverse items-center gap-16 py-24">
                <div class="lg:w-1/2">
                    <div
                        class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-appPurple/10 text-appPurple mb-6">
                        <i data-lucide="kanban" class="w-6 h-6"></i>
                    </div>
                    <h2 class="text-3xl lg:text-4xl font-bold mb-5 leading-tight">Work in your flow.</h2>
                    <p class="text-lg text-textMuted leading-relaxed">
                        Are you a visual planner or a data tracker? Switch effortlessly between an intuitive Kanban Board
                        and a structured Grid view with a single click. Flexible layouts tailored to how you think keep your
                        priorities straight, your way.
                    </p>
                </div>
                <!-- Staggered Image Component -->
                <div class="lg:w-1/2 w-full relative h-[300px] sm:h-[400px] lg:h-[500px]">
                    <img src="{{ asset('images/screenshot-2026-06-14-2-02-jpeg.jpg') }}" alt="Kanban Board View"
                        class="absolute top-0 left-0 w-4/5 rounded-2xl shadow-2xl border border-gray-200 z-10 hover:z-30 transition-z duration-300">
                    <img src="{{ asset('images/screenshot-2026-06-14-2-01-jpeg.jpg') }}" alt="Grid View"
                        class="absolute bottom-0 right-0 w-4/5 rounded-2xl shadow-2xl border border-gray-200 z-20 hover:z-30 transition-z duration-300 translate-y-8 sm:translate-y-0">
                </div>
            </div>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16 py-24">
                <div class="lg:w-1/2">
                    <div
                        class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-purple-100 text-purple-600 mb-6">
                        <i data-lucide="lock" class="w-6 h-6"></i>
                    </div>
                    <h2 class="text-3xl lg:text-4xl font-bold mb-5 leading-tight">Keep personal work private.</h2>
                    <p class="text-lg text-textMuted leading-relaxed">
                        Not everything needs to be a team discussion. Create distinct spaces for your private tasks
                        alongside your collaborative organization projects. Ensure total privacy for your deep work while
                        staying connected to the team.
                    </p>
                </div>
                <div class="lg:w-1/2 w-full">
                    <img src="{{ asset('images/screenshot-2026-06-14-2-00-jpeg.jpg') }}" alt="Private Projects Interface"
                        class="w-full rounded-2xl shadow-xl border border-gray-200">
                </div>
            </div>
            ...
            <div id="collaboration" class="flex flex-col lg:flex-row-reverse items-center gap-16 py-16">
                <div class="lg:w-1/2">
                    <div
                        class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-blue-100 text-blue-600 mb-6">
                        <i data-lucide="users" class="w-6 h-6"></i>
                    </div>
                    <h2 class="text-3xl lg:text-4xl font-bold mb-5 leading-tight">Frictionless team collaboration.</h2>
                    <p class="text-lg text-textMuted leading-relaxed">
                        Bring your team along in seconds. No complicated onboarding sequences. Simply drop in an email, send
                        an invite, and start delegating tasks instantly. Managing your organization’s roster is as clean as
                        the rest of your workflow.
                    </p>
                </div>
                <div class="lg:w-1/2 w-full">
                    <img src="{{ asset('images/screenshot-2026-06-14-2-03-jpeg.jpg') }}" alt="Organization and Invites"
                        class="w-full rounded-2xl shadow-xl border border-gray-200">
                </div>
            </div>
    ...
    <section class="relative py-32 overflow-hidden">
        ...
        <div
            class="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAiIGhlaWdodD0iMjAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMSIgY3k9IjEiIHI9IjEiIGZpbGw9InJnYmEoMjU1LDI1NSwyNTUsMC4xKSIvPjwvc3ZnPg==')] opacity-50">
        </div>
