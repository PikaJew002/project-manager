        ...
        <article class="relative z-10 max-w-3xl mx-auto">
            ...
            <section id="terms" class="mb-16">
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <p class="text-textMuted leading-relaxed">
                            All content, features, and functionality of the Service are owned by Project Manager and are protected by
            ...
            <section id="privacy" class="mb-16">
                ...
                <div class="space-y-8">
                    <div>
                        ...
                        <ul class="space-y-3 text-textMuted leading-relaxed">
                            <li><strong class="text-textDark font-medium">Personal Information:</strong> Email address and name provided during account registration.</li>
                            <li><strong class="text-textDark font-medium">User Content:</strong> The tasks, projects, and files you create and store in the platform.</li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-textMuted leading-relaxed">
                            To exercise these rights, please contact us at <a href="mailto:aaron@ironmthome.com" class="text-appPurple hover:underline">aaron@ironmthome.com</a>.
                        </p>
                    </div>
            ...
            <section id="contact" class="pt-8 border-t border-gray-200">
                ...
                <p class="text-textMuted leading-relaxed mb-4">
                    If you have any questions about these Terms of Service or Privacy Policy, please contact us at <a href="mailto:aaron@ironmthome.com" class="text-appPurple hover:underline">aaron@ironmthome.com</a>.
                </p>
                <ul class="space-y-2 text-textMuted">
                    <li><strong class="text-textDark font-medium">Email:</strong> aaron@ironmthome.com</li>
                </ul>
            </section>
        </article>
    </main>
