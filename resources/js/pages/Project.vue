  ...
  <AppLayout :page-route="route().current()">
    <div class="sm:flex sm:items-center pt-10 px-4 sm:px-6 lg:px-8">
      <div class="sm:flex-auto">
        <h1 class="text-base font-semibold text-gray-900">{{ organization.name }}</h1>
        <p class="mt-2 text-sm text-gray-700">A list of all users in your organization</p>
        <button type="button" @click="openManageUsersModal" class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm text-nowrap font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
          Manage Users
        </button>
      </div>
