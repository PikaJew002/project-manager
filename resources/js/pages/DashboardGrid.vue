...
pagesStore.setTasks(props.your_tasks);
...
<template>
  ...
  <AppLayout>
    ...
    <GridDashboard :tasks="tasks" @edit-task="openEditTaskModal" @update-task-status="updateTaskStatus" />
    <TaskModal :page="currentURL" @updated-tasks="onUpdatedTasks" @update-task-status="updateTaskStatus" />
  </AppLayout>
</template>
